...
CONVERT = 'python /Users/wuyibo/Documents/Research/tools/comp_bio-tapis-44cc05ebc78c/scripts/convertSam.py %s'
CLEAN   = 'python /Users/wuyibo/Documents/Research/tools/comp_bio-tapis-44cc05ebc78c/scripts/cleanAlignments.py -e %f -t %d -f %s -j %s -s %s -u %s -r %s %s %s'
